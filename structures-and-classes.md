...
![img](https://docs.swift.org/swift-book/images/sharedStateStruct\~dark@2x.png)
...
![img](https://docs.swift.org/swift-book/images/sharedStateClass\~dark@2x.png)
...
Note that _identical to_ (represented by three equals signs, or `===`) doesn’t mean the same thing as _equal to_ (represented by two equals signs, or `==`). _Identical to_ means that two constants or variables of class type refer to exactly the same class instance. _Equal to_ means that two instances are considered equal or equivalent in value, for some appropriate meaning of _equal_, as defined by the type’s designer.
